...
public class MenorOperacao extends AbstractOperacao {

	public static Logger logger = LoggerFactory.getLogger(MenorOperacao.class);
	...
	public void execute(MessageCreateEvent event) {
		...
		try {
			...
			if(jogoDAO.existeJogoStatusJogadorServer(usuarioOpereacao)) {
				...
				historicoJogoOLD.setOpcao(OpcoesJogo.MENOR);
