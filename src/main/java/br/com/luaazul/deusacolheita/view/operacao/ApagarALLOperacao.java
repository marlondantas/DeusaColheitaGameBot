...
public class ApagarALLOperacao extends AbstractOperacao {

	public static Logger logger = LoggerFactory.getLogger(ApagarALLOperacao.class);
	...
	public void execute(MessageCreateEvent event) {
		...
		try {
			...
			boolean saida = apagarOpereacaoService.deletarTudoDados(usuarioOpereacao);
			
			if(saida) {
				mensagem = "Todos os dados do BOT foram apagados.";
			}else {
